...
.PHONY: help install install-hooks setup-env lint test clean tooling-updater-build tooling-update-repo tooling-update-templates tooling-update-all tooling-update-micromamba tooling-update-mise tooling-update-system tooling-update-precommit tooling-verify render-precommit
