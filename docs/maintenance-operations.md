...
| **Bootstrap E2E Admin**              | [`bootstrap-e2e-admin.json`](github-app-manifests/bootstrap-e2e-admin.json)             | `e2e-cleanup` (scheduled deletion); test-generated E2E reads it at repo scope | `BOOTSTRAP_E2E_ADMIN_APP_CLIENT_ID` (var), `BOOTSTRAP_E2E_APP_OWNER` (var), `BOOTSTRAP_E2E_ADMIN_APP_PRIVATE_KEY` (secret), `BOOTSTRAP_E2E_ALLOWED_OWNERS` (var), `BOOTSTRAP_E2E_CENTRAL_REPOSITORY` (var)                                                            | `e2e-lifecycle`                                                                           |
