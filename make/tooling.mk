...
# =============================================================================
TOOLING_METADATA_ARGS := $(if $(TOOLING_METADATA_FILE),--metadata-file "$(TOOLING_METADATA_FILE)",)
...
tooling-update-precommit: tooling-updater-build ## Update pre-commit hook revisions for repo and templates
	@$(RUN) $(TOOLING_UPDATER_BIN) --scope all --updaters pre-commit $(TOOLING_METADATA_ARGS)
