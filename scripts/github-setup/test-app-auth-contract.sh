...
assert_not_contains "uses: ./.github/actions/resolve-gh-token" "$repo_root/.github/workflows/weekly-tooling-updates.yml"
assert_contains "GH_TOKEN: \${{ github.token }}" "$repo_root/.github/workflows/weekly-tooling-updates.yml"
assert_contains "automation_login=\"\$GITHUB_ACTOR\"" "$repo_root/.github/workflows/weekly-tooling-updates.yml"
assert_contains "automation_id=\"\$GITHUB_ACTOR_ID\"" "$repo_root/.github/workflows/weekly-tooling-updates.yml"
