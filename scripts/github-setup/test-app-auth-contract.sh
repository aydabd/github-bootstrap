...
assert_contains "inputs.permission_profile == 'repository-setup' || inputs.permission_profile == 'e2e-dispatch'" "$resolver"
...
assert_contains "Verify Bootstrap Writer installation access" "$repo_root/.github/workflows/weekly-tooling-updates.yml"
...
assert_contains "Bootstrap Writer repository access:" "$repo_root/.github/workflows/weekly-tooling-updates.yml"
assert_contains "Bootstrap Writer installation cannot see" "$repo_root/.github/workflows/weekly-tooling-updates.yml"
