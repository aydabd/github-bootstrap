...
assert_contains "gh api /installation --jq '{app_slug,repository_selection,permissions}'" "$repo_root/.github/workflows/classify-maintenance-pr.yml"
...
assert_contains "gh api /installation --jq '{app_slug,repository_selection,permissions}'" "$template_classifier"
