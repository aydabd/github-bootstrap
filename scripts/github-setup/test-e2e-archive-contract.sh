...
grep -q 'cleanup-generated-maintenance' "$workflow"
...
grep -q 'permission_profile: repository-cleanup' "$workflow"
grep -q 'BOOTSTRAP_E2E_PROVISIONER_APP_PRIVATE_KEY' "$workflow"
