...
contract_tests=(
    ...
    "$script_dir/test-repository-creation-parity-contract.sh"
    ...
    "$script_dir/github-setup/test-agent-closeout-contract.sh"
    ...
    "$script_dir/github-setup/test-dispatch-e2e-contract.sh"
